...
public class Human extends InteractionObject {
    private String name;
    private Mood mood;
    private int height;
    ...
    public String toString() {
        if (this.takenBy == null & this.movedBy == null) {
        ...
        } else if (!(this.takenBy == null) & this.movedBy == null) {
            ...
            return String.format("<Human name='%s' mood=%s height=%d takenBy=null moveBy=%s damaged=%b>", this.name, this.mood, this.height, this.movedBy.getName(), this.damaged);
        }
        return String.format("<Human name='%s' mood=%s height=%d takenBy=%s moveBy=%s damaged=%b>", this.name, this.mood, this.height, this.takenBy.getName(), this.movedBy.getName(), this.damaged);
    }
